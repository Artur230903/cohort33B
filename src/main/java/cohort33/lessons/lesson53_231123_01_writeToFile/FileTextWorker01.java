...
public class FileTextWorker01 {

  private static final String SOURCE_FILE = "sourceA.txt";

  private static final String DESTINATION_FILE = "destination.txt";

  private static final Logger LOGGER = LoggerFactory.getLogger(FileTextWorker01.class);
